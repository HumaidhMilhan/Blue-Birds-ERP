...
- **Dialogs:** Modal `Window` subclasses for batch picker, product picker, add product, record purchase, create business account, record payment, edit terms
...
- Twilio WhatsApp sender is a stub (configuration instructions in README.md)
